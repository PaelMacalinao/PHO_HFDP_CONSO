...
CREATE TABLE IF NOT EXISTS users (
    ...
    role ENUM('admin', 'staff') DEFAULT 'staff' COMMENT 'admin=Full access, staff=Facility-restricted access',
    assigned_facility VARCHAR(255) COMMENT 'Facility assignment for staff users',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_role (role)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
